...
export interface ApiEmpleadoEmpleado extends Schema.CollectionType {
  ...
  attributes: {
    nombre: Attribute.String & Attribute.Required & Attribute.Unique;
    puesto: Attribute.String & Attribute.Required;
...
export interface ApiPilarPilar extends Schema.CollectionType {
  ...
  attributes: {
    ...
    proyectos: Attribute.Relation<
      ...
      'api::proyecto.proyecto'
    >;
    slug: Attribute.UID<'api::pilar.pilar', 'nombre'> & Attribute.Required;
    titular: Attribute.String & Attribute.Required;
    descripcion: Attribute.Text & Attribute.Required;
    contacto: Attribute.Component<'components.contacto'> & Attribute.Required;
...
export interface ApiProyectoProyecto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    cliente: Attribute.Relation<
      ...
      'api::cliente.cliente'
    >;
    pilar: Attribute.Relation<
      'api::proyecto.proyecto',
      'manyToOne',
      'api::pilar.pilar'
    >;
    slug: Attribute.UID<'api::proyecto.proyecto', 'nombre'> &
      Attribute.Required;
