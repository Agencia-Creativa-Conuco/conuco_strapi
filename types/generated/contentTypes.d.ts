...
export interface ApiPilarPilar extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contacto: Schema.Attribute.Component<'components.contacto', false> &
      Schema.Attribute.Required;
...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pilar: Schema.Attribute.Relation<'manyToOne', 'api::pilar.pilar'>;
    slug: Schema.Attribute.UID<'nombre'> & Schema.Attribute.Required;
